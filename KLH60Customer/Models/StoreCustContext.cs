...
namespace KLH60Customer.Models
{
    public partial class StoreCustContext : IdentityDbContext
    {
        ...
        public StoreCustContext() => Database.EnsureCreated();

        public StoreCustContext(DbContextOptions<StoreCustContext> options, IConfiguration config) : base(options)
        {
